  ...
  return (
    <div
      className={`
        ...
        ${selected ? "border-primary shadow-xl ring-2 ring-primary/20 node-glow" : "border-border"}
        glass-effect
      `}
      onClick={handleClick}
    >
      ...
      <div className="flex items-center gap-3 mb-3">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">Text message to user</p>
        </div>
      </div>

      <div className="text-sm text-foreground bg-muted/50 rounded-lg p-3 border border-border/50 font-medium">
        {data.text}
      </div>
